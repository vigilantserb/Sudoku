...
import com.stameni.sudoku.GameSettings
import com.stameni.sudoku.Statistics
import com.stameni.sudoku.Statistics.getDefaultInstance
...
private object GameSettingsSerializer: Serializer<GameSettings> {
    ...
    override suspend fun writeTo(t: GameSettings, output: OutputStream) {
        t.writeTo(output)
    }
}
